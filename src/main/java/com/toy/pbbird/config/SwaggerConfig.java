...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket swaggerApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(swaggerInfo())
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.toy.pbbird"))
    ...
    private ApiInfo swaggerInfo() {
        return new ApiInfoBuilder().title("PostBird pbbird API")
                .description("포스트버드 새 api 문서 입니다. ").build();
    }
